...
public class Potential<K> {
	...
	public ArrayList<Vertex<K>> vertices = new ArrayList<>();
	private double[] one_dimension;
	private double[][] two_dimension;
	private double[][][] three_dimension;
	...
	public Potential(double[][][] three_dimension, Vertex<K> value1, Vertex<K> value2, Vertex<K> value3){
		vertices.add(value1);
		vertices.add(value2);
		vertices.add(value3);
		this.three_dimension = new double[value1.getNum_states()][value2.getNum_states()][value3.getNum_states()];
	...
	//Takes a 3 dimensional potential and finds where in a 3-d potential it matches vertices and then multiplies the 3-d potential into the 
				...
				for(int i = 0; i < result_array.length; i++)
					for(int j = 0; j < result_array[0].length; j++)
						for(int k = 0; k < result_array[0][0].length; k++)
							result_array[i][j][k] = this.three_dimension[i][j][k]*given.three_dimension[i][j][k];
			else //"AEC"
				for(int i = 0; i < result_array.length; i++)
					for(int j = 0; j < result_array[0].length; j++)
						for(int k = 0; k < result_array[0][0].length; k++)
							result_array[i][j][k] = this.three_dimension[i][j][k]*given.three_dimension[i][k][j];
		}
		else 
		if(given.vertices.get(0).equals(this.vertices.get(1))){
			if(given.vertices.get(1).equals(this.vertices.get(0)))//"CAE"
				for(int i = 0; i < result_array.length; i++)
					for(int j = 0; j < result_array[0].length; j++)
						for(int k = 0; k < result_array[0][0].length; k++)
							result_array[i][j][k] = this.three_dimension[i][j][k]*given.three_dimension[j][i][k];
			else//"CEA"
				for(int i = 0; i < result_array.length; i++)
					for(int j = 0; j < result_array[0].length; j++)
						for(int k = 0; k < result_array[0][0].length; k++)
							result_array[i][j][k] = this.three_dimension[i][j][k]*given.three_dimension[j][k][i];
		}
		else{
			if(given.vertices.get(1).equals(this.vertices.get(0)))//"EAC"
				for(int i = 0; i < result_array.length; i++)
					for(int j = 0; j < result_array[0].length; j++)
						for(int k = 0; k < result_array[0][0].length; k++)
							result_array[i][j][k] = this.three_dimension[i][j][k]*given.three_dimension[k][i][j];
			else//"ECA"
				for(int i = 0; i < result_array.length; i++)
					for(int j = 0; j < result_array[0].length; j++)
						for(int k = 0; k < result_array[0][0].length; k++)
							result_array[i][j][k] = this.three_dimension[i][j][k]*given.three_dimension[k][j][i];
		}
		Potential<K> result = new Potential<K>(result_array, this.vertices.get(0), this.vertices.get(1), this.vertices.get(2));
		return result;
	}

	//Takes a 2 dimensional potential and finds where in a 3-d potential it matches vertices and then multiplies the 2-d potential into the 
	//3-d one. If the 3-d one has vertices "ACE" the matches are shown below
		...
		if(given.vertices.get(0).equals(this.vertices.get(0))){
			if(given.vertices.get(1).equals(this.vertices.get(1)))//"AC"
				for(int i = 0; i < result_array.length; i++)
					for(int j = 0; j < result_array[0].length; j++)
						for(int k = 0; k < result_array[0][0].length; k++)
							result_array[i][j][k] = this.three_dimension[i][j][k]*given.two_dimension[i][j];
			else //"AE"
				for(int i = 0; i < result_array.length; i++)
					for(int j = 0; j < result_array[0].length; j++)
						for(int k = 0; k < result_array[0][0].length; k++)
							result_array[i][j][k] = this.three_dimension[i][j][k]*given.two_dimension[i][k];
		}
		else 
		if(given.vertices.get(0).equals(this.vertices.get(1))){
			if(given.vertices.get(1).equals(this.vertices.get(0)))//"CA"
				for(int i = 0; i < result_array.length; i++)
					for(int j = 0; j < result_array[0].length; j++)
						for(int k = 0; k < result_array[0][0].length; k++)
							result_array[i][j][k] = this.three_dimension[i][j][k]*given.two_dimension[j][i];
			else//"CE"
				for(int i = 0; i < result_array.length; i++)
					for(int j = 0; j < result_array[0].length; j++)
						for(int k = 0; k < result_array[0][0].length; k++)
							result_array[i][j][k] = this.three_dimension[i][j][k]*given.two_dimension[j][k];
		}
		else{
			if(given.vertices.get(1).equals(this.vertices.get(0)))//"EA"
				for(int i = 0; i < result_array.length; i++)
					for(int j = 0; j < result_array[0].length; j++)
						for(int k = 0; k < result_array[0][0].length; k++)
							result_array[i][j][k] = this.three_dimension[i][j][k]*given.two_dimension[k][i];
			else//"EC"
				for(int i = 0; i < result_array.length; i++)
					for(int j = 0; j < result_array[0].length; j++)
						for(int k = 0; k < result_array[0][0].length; k++)
							result_array[i][j][k] = this.three_dimension[i][j][k]*given.two_dimension[k][j];
		}
		Potential<K> result = new Potential<K>(result_array, this.vertices.get(0), this.vertices.get(1), this.vertices.get(2));
		return result;
	}

	//Takes a 1 dimensional potential and finds where in a 3-d potential it matches vertices and then multiplies the 1-d potential into the 
	//3-d one. If the 3-d one has vertices "ACE" the matches are shown below
	private Potential<K> multiply1x3(Potential<K> given) {
		...
		for(int i = 0; i < result_array.length; i++)
			for(int j = 0; j < result_array[0].length; j++)
				for(int k = 0; k < result_array[0][0].length; k++)
					result_array[i][j][k] = this.three_dimension[i][j][k]*given.one_dimension[i];
		}
		else
		if(given.vertices.get(0).equals(this.vertices.get(1))){//"C"
			for(int i = 0; i < result_array.length; i++)
				for(int j = 0; j < result_array[0].length; j++)
					for(int k = 0; k < result_array[0][0].length; k++)
						result_array[i][j][k] = this.three_dimension[i][j][k]*given.one_dimension[j];
		}
		else//"E"
			for(int i = 0; i < result_array.length; i++)
				for(int j = 0; j < result_array[0].length; j++)
					for(int k = 0; k < result_array[0][0].length; k++)
						result_array[i][j][k] = this.three_dimension[i][j][k]*given.one_dimension[k];
	...
	//Given a potential with 3 dimensions, takes the sum over like combinations of states for the variables not being summed over.  This method
	//effectively removes the variable in question from the table while keeping the information it stored in the table.
	...
	//Returns the probabilities associated with the possible states of the given variable.  Sums out all other variables.
	...
	//Divides each element in the current potential by the corresponding element in a given potential
	...
	public Potential<K> normalize(){
		...
		result = new Potential<K>(this.three_dimension, vertices.get(0), vertices.get(1), vertices.get(2));
		return result;
	}
	...
	//Gives the one_dimension array as this is the result of the marginalization
